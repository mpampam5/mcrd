...
$string .="\n\n<div class=\"box\">
  <div class=\"box-header with-border\">
    ...
    <div class='box-tools pull-right'>
      <a href='<?=site_url(\"$c_url/tambah\")?>' id='tambah' class='btn btn-success btn-sm'> Tambah</a>
    </div>
  </div>
...
$string .= "\n\t\t\t\t\t\t\t\t<th>Action</th>
        ...
        <tr>";
            ...
            ."\n\t\t\t\t\t\t\t<a href=\"<?=site_url(\"$c_url/detail/\$".$c_url."->".$pk."\")?>\" id=\"detail\" class=\"btn btn-sm btn-primary\">detail</a> "
            ."\n\t\t\t\t\t\t\t<a href=\"<?=site_url(\"$c_url/edit/\$".$c_url."->".$pk."\")?>\" id=\"edit\" class=\"btn btn-sm btn-warning\">edit</a> "
            ."\n\t\t\t\t\t\t\t<a href=\"<?=site_url(\"$c_url/hapus/\$".$c_url."->".$pk."\")?>\" id=\"hapus\" class=\"btn btn-sm btn-danger\">hapus</a>"
                    . "\n\t\t\t\t\t</td>";
            $string .=  "\n\t\t\t</tr>
              <?php } ?>
            <tbody>
...
$string .="\n<script type=\"text/javascript\">
   ...
   //     });
    ...
    $hasil_view_list = createFile($string,$target."".$direct_created_view."". $v_list_file);
