...
/* http://harviacode.com */
 ...
 class Pengguna extends MY_Controller{
  function __construct(){
      ...
      if ($this->cl->acl("cpanel/pengguna")==false) {
 ...
 function index(){
    ...
    $this->layouts->view('cpanel/content/pengguna/index',array(),$data);
  }
    ...
    if($row=$this->model->get_where_join($id)){
      $this->layouts->set_title('Pengguna');
        $data=array('layout_title' => 'Pengguna',
				 ...
				 $this->layouts->view('cpanel/content/pengguna/detail',array(),$data);
//MODAL DETAIL
//$this->layouts->view('cpanel/content/pengguna/detail',array(),$data,false);
    }else {
        $this->error_404();
    }
  }
 ...
 function tambah($status=''){
    if ($status=='aksi') {
      ...
      $data = array('layout_title' => 'Pengguna',
                      'button'=>'tambah',
                      'aksi' =>site_url('cpanel/pengguna/tambah/aksi'),
			 ...
			 $this->layouts->view('cpanel/content/pengguna/form',array(),$data);
  //MODAL TAMBAH
  //$this->layouts->view('cpanel/content/pengguna/form',array(),$data,false);
     }
  }
 ...
 function edit($id,$status=''){
      ...
      if($row=$this->model->get_where($id)){
        ...
        $data = array('layout_title' => 'Pengguna',
                      'button'=>'edit',
                      'aksi' =>site_url('cpanel/pengguna/edit/'.$id.'/aksi'),
...
function change_password($id){
  $data['id_auth'] = $id;
  $this->layouts->view('cpanel/content/pengguna/change',array(),$data,false);
}
