...
class Menus extends MY_Controller{
  ...
  public function __construct()
  {
    ...
    if ($this->cl->acl("cpanel/menus")==false) {
  ...
  function tambah($status="")
  {
    if ($this->input->is_ajax_request()) {
        if ($status=="aksi") {
          ...
          $data['status']="tambah";
          $this->layouts->view("cpanel/content/menus/form",array(),$data,false);
        }
    }
  }
  ...
  function info($id)
  {
    if ($this->input->is_ajax_request()) {
      $data['row']   =$this->model->get_where(array("id"=>$id))->row();
      $data['status']="edit";
      $this->layouts->view("cpanel/content/menus/info",array(),$data,false);
    }
  }
