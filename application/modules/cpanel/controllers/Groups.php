...
/* http://harviacode.com */
 ...
 class Groups extends MY_Controller{
  function __construct(){
      ...
      if ($this->cl->acl("cpanel/groups")==false) {
 ...
 function index(){
    ...
    $this->layouts->view('cpanel/content/groups/index');
  }
...
function json() {
 ...
 //        $data=array('layout_title' => 'Groups',
	...
	// 								);
	// 			 $this->layouts->view('cpanel/content/groups/detail',array(),$data);
//MODAL DETAIL
//$this->layouts->view('cpanel/content/groups/detail',array(),$data,false);
  //   }else {
  //       $this->error_404();
  //   }
  // }
 ...
 function tambah($status=''){
    if ($status=='aksi') {
      ...
      $data = array('layout_title' => 'Groups',
                      'button'=>'tambah',
                      'aksi' =>site_url('cpanel/groups/tambah/aksi'),
											'id_level' => set_value('id_level'),
											'level' => set_value('level'),
											'description' => set_value('description'),
											'access' => set_value('access'),
											);
			 $this->layouts->view('cpanel/content/groups/form',array(),$data);
  //MODAL TAMBAH
  //$this->layouts->view('cpanel/content/groups/form',array(),$data,false);
     }
  }
 ...
 function edit($id,$status=''){
      ...
      if($row=$this->model->get_where($id)){
        ...
        $data = array('layout_title' => 'Groups',
                      'button'=>'edit',
                      'aksi' =>site_url('cpanel/groups/edit/'.$id.'/aksi'),
