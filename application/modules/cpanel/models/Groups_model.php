  ...
  var $id    = 'id_level';
    ...
    // datatables
      function json() {
          ...
          // '<a href="'.site_url("cpanel/groups/detail/$1").'" id="detail" class="btn btn-sm btn-primary">detail</a>
           '<a href="'.site_url("cpanel/groups/edit/$1").'" id="edit" class="btn btn-sm btn-warning">edit</a>
           <a href="'.site_url("cpanel/groups/hapus/$1").'" id="hapus" class="btn btn-sm btn-danger">hapus</a>',
           'id_level');
