  ...
  <div class="box-body">
      ...
      <form action="<?=$aksi?>" id="form">
             ...
             <?php endif; ?>
                ...
                <?=cmb_dinamis('groups','groups','groups','level','id_level',$groups) ?>
            </div>
        ...
        <div class="row">
            ...
            <!-- <button type="button" class="btn btn-default btn-sm btn-block" data-dismiss="modal" aria-label="Close">tutup</button> -->
              <a href="<?=site_url('cpanel/pengguna')?>" class="btn btn-sm btn-default btn-block"> batal</a>
            </div>
              ...
              $('#pesan').append('<div class="alert alert-success">'+
                ...
                $('.alert-success').delay(500).show(10, function(){
                  $('.alert-success').delay(5000).hide(10, function(){
                    ...
                    window.location.href="<?=site_url('cpanel/pengguna')?>";
                  });
                })
            }else {
