...
<div class="box">
  <div class="box-header with-border">
    ...
    <div class='box-tools pull-right'>
      <a href='<?=site_url("cpanel/pengguna/tambah")?>' id='tambah' class='btn btn-success btn-sm'> Tambah</a>
    </div>
  </div>
  ...
  <div class="box-body">
      <div id="alert"></div>
        ...
        <tr>
              ...
              <a href="<?=site_url("cpanel/pengguna/change_password/$pengguna->id_auth")?>" id="reset" class="btn btn-info btn-sm"><i class="fa fa-key"></i></a>
							<a href="<?=site_url("cpanel/pengguna/detail/$pengguna->id_auth")?>" id="detail" class="btn btn-sm btn-primary">detail</a>
							<a href="<?=site_url("cpanel/pengguna/edit/$pengguna->id_auth")?>" id="edit" class="btn btn-sm btn-warning">edit</a>
							<a href="<?=site_url("cpanel/pengguna/hapus/$pengguna->id_auth")?>" id="hapus" class="btn btn-sm btn-danger">hapus</a>
					</td>
			</tr>
              <?php } ?>
            <tbody>
