...
<div class="box">
  ...
  <table class="table">
    <?php if ($image!=""): ?>
      <tr><td>Gambar</td><td><img src="<?=base_url()?>/temp/upload/thumbs/<?=$image?>" class="img img-responsive img-thumbnail" alt="<?=$image?>"></td></tr>
    <?php endif; ?>
    ...
    <a href="<?=site_url("cpanel/pengguna/change_password/$id_auth")?>" id="reset" class="btn btn-info btn-sm"><i class="fa fa-key"></i> Ubah Password</a>
  </div>
</div>
