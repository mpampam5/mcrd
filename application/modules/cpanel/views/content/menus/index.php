 ...
 <div class="box">
   <div class="box-header with-border">
     ...
     <div class="box-tools pull-right">
       <a href="<?=base_url()?>/cpanel/Menus/tambah" id="tambah" class="btn btn-success btn-sm"> Tambah</a>
                      ...
                      if ($value['active']==1) {
                        ...
                        $html.= '<li class="dd-item dd3-item" data-id="'.$value['id'].'" >
                                    ...
                                    <div class="dd3-content"><span id="label_show'.$value['id'].'">'.strtoupper($value['label']).'</span>
                                        <span class="span-right"><i id="link_show'.$value['id'].'">'.strtolower(site_url($value['link'])).'</i> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$active.' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="'.base_url().'cpanel/menus/info/'.$value['id'].'"  id="info" ><i class="fa fa-exclamation-circle text-success"></i></a>&nbsp;
                                            <a href="'.base_url().'cpanel/menus/edit/'.$value['id'].'"  id="edit" ><i class="fa fa-pencil text-info"></i></a>&nbsp;
                                            <a href="'.base_url().'cpanel/menus/hapus/'.$value['id'].'" alt="'.$value['id'].'" id="hapus"><i class="fa fa-trash text-danger"></i></a></span>
                                    </div>';
...
<script>
   $(document).ready(function(){
    ...
    $('.dd').on('change', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?=base_url()?>cpanel/menus/save",
            data: dataString,
            cache : false,
